...
<template>
  <div class="app-shell">
    <SideNav :current-page="currentPage" :feedback-unread="feedbackUnread" :user="user" :can-access-clients="canAccessClients" @navigate="$emit('navigate', $event)" @feedback="$emit('feedback')" />
    <main>
