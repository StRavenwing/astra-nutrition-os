...
export const exerciseMachineOptions = [
  'Без тренажёра', 'Блочный тренажёр', 'Кроссовер', 'Смит-машина', 'Силовая рама',
  'Скамья', 'Тренажёр для жима ногами', 'Тренажёр для разгибания ног',
  'Тренажёр для сгибания ног', 'Тренажёр для сведения/разведения ног',
  'Тренажёр для ягодиц', 'Гиперэкстензия', 'Кардио-тренажёр'
];

export const exerciseEquipmentOptions = [
  'Без инвентаря', 'Гантели', 'Штанга', 'Диски', 'Гиря', 'Резиновая лента',
  'Эспандер', 'Фитбол', 'Медбол', 'Степ-платформа', 'Турник', 'Петли TRX', 'Коврик'
];
