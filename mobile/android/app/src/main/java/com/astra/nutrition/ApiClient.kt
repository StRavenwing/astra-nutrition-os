...
private fun JSONObject.exerciseVariant() = ExerciseVariant(optTextOrNull("machine"), optTextOrNull("equipment"), optTextOrNull("description"), optTextOrNull("technique"), optTextOrNull("tips"), optTextOrNull("name"))
